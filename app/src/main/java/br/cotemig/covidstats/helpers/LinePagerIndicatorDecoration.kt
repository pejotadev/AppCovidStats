package br.cotemig.covidstats.helpers
...
class LinePagerIndicatorDecoration(var listner: OnViewPosition?) : RecyclerView.ItemDecoration() {
    ...
    private fun drawHighlights(
        ...
        listner?.let{
            it.onViewPosition(highlightPosition)
        }
    ...
    interface  OnViewPosition{
        fun onViewPosition(position: Int)
    }
}